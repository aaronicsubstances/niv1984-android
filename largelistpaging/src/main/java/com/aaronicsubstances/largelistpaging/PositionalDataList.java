...
/**
 * Internal class for presenting currently loaded pages in {@link PositionalDataPaginator}
 * to {@link FiniteListAdapter} as a {@link List}.
 * @param <E>
 */
class PositionalDataList<E> extends AbstractList<E> {
    private final int totalCount;
    private final int pageSize;
    private final Map<Integer, List<E>> loadedPages;

    public PositionalDataList(int totalCount, int pageSize, Map<Integer, List<E>> loadedPages) {
