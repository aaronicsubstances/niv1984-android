                ...
                for (c in v.children()) {
                    ...
                    if (elemClasses) {
                        if (elemClasses.contains("content")) {
                            ...
                            processContent(quoteEl, c.children().get(0), FancyContentKind.EM)
                        }
                        else if (elemClasses.contains("qs")) {
                            assert elemClasses.size() == 1
                            assert c.children().size() == 1
                            processContent(quoteEl, c.children().get(0), FancyContentKind.SELAH)
                        }
                            ...
                            if (elemClasses.contains("x")) {
                                ...
                                processNoteF(bookDir, cn, quoteEl, c, currVnum, ++noteNumber, footNoteList)
                            }
                        }
